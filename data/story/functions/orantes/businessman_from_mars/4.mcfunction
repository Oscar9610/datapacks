...
execute if score businessman_from_mars story matches 7 run tag @a[tag=p1] remove businessman_from_mars_require
execute if score businessman_from_mars story matches 7 run tag @a[tag=p1] add businessman_from_mars_3
