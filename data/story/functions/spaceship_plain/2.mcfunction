execute if score spaceship_plain story matches 25 run tellraw @a {"text":"［希爾］我們到了"}
execute if score spaceship_plain story matches 24 run tellraw @a {"text":"［希爾］這是我的房間，對面則是你的"}
