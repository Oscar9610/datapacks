...
execute if entity @a[advancements={story:traded_rpg_weapons=true}] if score spaceship_plain_2 story matches 24 if data entity @e[type=minecraft:interaction,tag=Emera,limit=1,sort=nearest] interaction.timestamp run function story:spaceship_plain/8
