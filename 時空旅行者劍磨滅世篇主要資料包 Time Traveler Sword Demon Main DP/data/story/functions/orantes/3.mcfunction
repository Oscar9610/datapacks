...
execute positioned -64 63 5 in game_map:orantes as @a[distance=..30] if score orantes story matches 11 run effect give @s slowness infinite 255 true
execute positioned -64 63 5 in game_map:orantes as @a[distance=..30] if score orantes story matches 11 run effect give @s jump_boost infinite 128 true
execute positioned -64 63 5 in game_map:orantes as @a[distance=..30] if score orantes story matches 11 run effect give @s instant_health 1 27 true
execute positioned -64 63 5 in game_map:orantes as @a[distance=..30] if score orantes story matches 11 run effect give @s resistance infinite 255 true
...
execute positioned -64 63 5 in game_map:orantes as @a[distance=..30] if score orantes story matches 11 run title @s title {"text":"\uE000"}
execute positioned -64 63 5 in game_map:orantes as @a[distance=..30] if score orantes story matches 11 run title @s times 10 100000 0
