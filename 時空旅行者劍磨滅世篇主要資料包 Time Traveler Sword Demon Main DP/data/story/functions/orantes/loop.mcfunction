...
execute positioned -6 63 165 as @a if entity @s[dx=23,dz=23,dy=5] if dimension game_map:orantes if score #orantes_main story_stage matches 6 run scoreboard players set orantes story 30
execute positioned -6 63 165 as @a if entity @s[dx=23,dz=23,dy=5] if dimension game_map:orantes if score #orantes_main story_stage matches 6 run function story:orantes/5
execute positioned -6 63 165 as @a if entity @s[dx=23,dz=23,dy=5] if dimension game_map:orantes if score #orantes_main story_stage matches 6 run scoreboard players set #orantes_main story_stage 7
