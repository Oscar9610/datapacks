...
execute if score orantes story matches 11 run function story:orantes/main_line/rescue_statement/remove_display_monster

#劇情
#story
execute if score orantes story matches 11 run tellraw @a {"text":"［希爾］你還好嗎?！"}

execute positioned -64 63 5 in game_map:orantes as @a[distance=..30] if score orantes story matches 11 run function story:orantes/main_line/rescue_statement/tp
execute positioned -64 63 5 in game_map:orantes if score orantes story matches 11 run kill @e[tag=statement,distance=..2]
...
execute positioned -64 63 5 in game_map:orantes as @a[distance=..30] if score orantes story matches 15 run function story:orantes/main_line/rescue_statement/3

#循環
#loop
execute if score orantes story matches 11..15 run scoreboard players add orantes story 1
execute if score orantes story matches 11..15 run schedule function story:orantes/main_line/rescue_statement/2 4s