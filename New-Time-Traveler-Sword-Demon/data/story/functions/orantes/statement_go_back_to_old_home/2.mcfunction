...
execute positioned -222 -55 -546 in game_map:orantes if score statement_go_back_to_old_home story matches 6 run tellraw @a[distance=..20] {"text":"［希爾］陳述你怎麼跑掉不等我們一下"}
