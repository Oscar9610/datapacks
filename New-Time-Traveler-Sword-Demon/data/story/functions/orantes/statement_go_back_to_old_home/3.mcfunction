...
execute positioned -189 59 -7 in game_map:orantes if score statement_go_back_to_old_home story matches 9 run tellraw @a[distance=..20] {"text":"［陳述］找到了！這下可以回去奧蘭蒂斯城市了！"}
...
execute positioned -189 59 -7 in game_map:orantes if score statement_go_back_to_old_home story matches 11 run tellraw @a[distance=..20] {"text":"［陳述］我...我怕怪物，但我也不想失去這個飾品。你們能幫我嗎？"}
...
execute positioned -189 59 -7 in game_map:orantes if score statement_go_back_to_old_home story matches 14 run title @a[distance=..20] times 20 20 20
execute positioned -189 59 -7 in game_map:orantes if score statement_go_back_to_old_home story matches 14 run title @a[distance=..20] title {"text":"\uE002"}
