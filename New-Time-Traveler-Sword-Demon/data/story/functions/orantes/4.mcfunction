...
execute positioned -64 63 5 in game_map:orantes as @a[distance=..30] if score orantes story matches 16 run tellraw @s {"text":"［陳述］我叫陳述，是避難營地為數不多的小孩之一"}
...
execute positioned -64 63 5 in game_map:orantes as @a[distance=..30] if score orantes story matches 21 run title @s title {"text":"\uE002"}
execute positioned -64 63 5 in game_map:orantes as @a[distance=..30] if score orantes story matches 21 run title @s times 10 40 10
