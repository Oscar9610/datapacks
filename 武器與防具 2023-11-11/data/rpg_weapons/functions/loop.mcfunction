...
execute as @a[scores={wind_sword_cd=0,rightclick=1..},nbt={SelectedItem:{tag:{wind_sword:1b}}}] at @s run function rpg_weapons:rightclick/wind_sword/rightclick
execute as @a[scores={double_sword_fire_cd=0,rightclick=1..},nbt={SelectedItem:{tag:{double_sword:2b}}}] at @s run function rpg_weapons:rightclick/double_sword_fire/start
execute as @a[scores={double_sword_fire_cd=0,rightclick=1..},nbt={SelectedItem:{tag:{double_sword:-2b}}}] at @s run function rpg_weapons:rightclick/double_sword_fire/start