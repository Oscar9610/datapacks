...
execute if score #orantes_main stoey_stage matches ..3 run scoreboard players set orantes story 9
execute if score #orantes_main stoey_stage matches ..3 run scoreboard players set #orantes_main stoey_stage 1
