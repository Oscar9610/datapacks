...
execute positioned -370 -58 -432 as @e[distance=..30,type=item,nbt={Item:{tag:{money:1b}}}] run kill @s
execute positioned -370 -58 -432 if dimension game_map:orantes_dungeon run kill @e[type=experience_orb,distance=..30]
