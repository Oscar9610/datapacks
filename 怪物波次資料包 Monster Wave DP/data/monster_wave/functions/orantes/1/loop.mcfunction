execute positioned -64 63 5 in game_map:orantes unless entity @a[distance=..30] run function monster_wave:orantes/1/reset
...
execute positioned -64 63 5 in game_map:orantes as @e[type=!player,tag=orantes_1_monster_wave,distance=30..] at @s run tp @s ~ ~ ~ facing -370 -58 -432
...
execute positioned -64 63 5 in game_map:orantes if entity @a[distance=..30] run schedule function monster_wave:orantes/1/loop 1t