...
execute positioned -221 -58 -516 in game_map:orantes as @a if entity @a[distance=..30] if score #orantes_main stoey_stage matches 5 run function monster_wave:orantes/2/open
execute positioned -221 -58 -516 in game_map:orantes as @a if entity @a[distance=..30] if score #orantes_main stoey_stage matches 5 run scoreboard players set #orantes_main stoey_stage 6

execute positioned -6 -62 -3 in game_map:orantes_dungeon as @a if entity @a[distance=..30] if score #orantes_main stoey_stage matches 8 run function monster_wave:orantes/3/open
execute positioned -6 -62 -3 in game_map:orantes_dungeon as @a if entity @a[distance=..30] if score #orantes_main stoey_stage matches 8 run scoreboard players set #orantes_main stoey_stage 9
